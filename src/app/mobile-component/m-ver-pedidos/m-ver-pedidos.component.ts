...
@Component({
  selector: 'app-m-ver-pedidos',
  imports: [FormsModule, CommonModule],
  templateUrl: './m-ver-pedidos.component.html',
  styleUrl: './m-ver-pedidos.component.css'
})
export class MVerPedidosComponent implements OnInit {
  data:any;
  evento:any;
  estadoActual:any = '';
  estadoNuevo:any;
