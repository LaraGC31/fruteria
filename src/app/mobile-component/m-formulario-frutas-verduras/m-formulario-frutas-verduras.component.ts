...
@Component({
  selector: 'app-m-formulario-frutas-verduras',
  imports: [FormsModule],
  templateUrl: './m-formulario-frutas-verduras.component.html',
  styleUrl: './m-formulario-frutas-verduras.component.css'
})
export class MFormularioFrutasVerdurasComponent implements OnInit {
nombre:string = '';
stock:any = '1';
idCategoria:any = '';
descripcion:string = '';
