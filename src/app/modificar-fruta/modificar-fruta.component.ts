...
@Component({
  selector: 'app-modificar-fruta',
  imports: [FormsModule],
  templateUrl: './modificar-fruta.component.html',
  styleUrl: './modificar-fruta.component.css'
})
export class ModificarFrutaComponent implements OnInit{
tipo:any = '';
data:any;
data2:any = {};
  ...
  getNombreProductosFruta(){
      this.productosService.getNombreProductosFruta().subscribe((data)=>{
      this.data = data;
    })
  }
