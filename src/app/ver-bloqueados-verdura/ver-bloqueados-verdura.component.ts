...
@Component({
  selector: 'app-ver-bloqueados-verdura',
  imports: [FormsModule],
  templateUrl: './ver-bloqueados-verdura.component.html',
  styleUrl: './ver-bloqueados-verdura.component.css'
})
export class VerBloqueadosVerduraComponent {
data: any = '';
